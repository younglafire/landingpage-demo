              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {studyTools.map((tool, index) => (
                  ...
                  >
                    ...
                    <button 
                      onClick={() => {
                        setActiveToolDemo(activeToolDemo === tool.id ? null : tool.id);
                      }}
                    ...
                    >
                      <span>{activeToolDemo === tool.id ? 'Ẩn Demo' : 'Dùng Thử Ngay'}</span>
                    ...
                    {filteredAiTools.map((tool, index) => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mt-auto">
                          ...
                          <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium flex items-center justify-center space-x-1 text-sm px-4 py-2 rounded-lg hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                            <span>Khám Phá</span>
                    ...
                    {filteredMaterials.map((material, index) => (
                      ...
                      >
                        ...
                        <div className="flex space-x-2 mt-auto">
                          <button className="flex-1 bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-lg font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 text-sm">
                            Truy Cập Tài Liệu
                          </button>
              ...
              <div className="grid md:grid-cols-4 gap-8">
                <div>
                  <div className="flex items-center space-x-2 mb-4">
                    <img src="/logo.png" alt="Study VHU Logo" className="w-12 h-12 object-contain" />
